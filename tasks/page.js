...
module.exports = function( grunt ) {
   ...
   */
  grunt.registerTask('page', 'Compile Grunt Docs to HTML', function() {
    var done = this.async();
    ...
    function generateDocs( local ) {
      ...
      function generateGuides() {
        ...
        // API Docs
        var sidebars = [];
        var names = grunt.file.expand({cwd: base, filter: 'isFile'}, ['*.md']);
        ...
        names.forEach(function( name ) {
          ...
          grunt.file.copy(src, dest, {
            process: function( src ) {
              try {
                var file = 'src/tmpl/page.jade', templateData = {
                    page: 'page',
                    rootSidebar: true,
                    pageSegment: segment,
